...
@section('title', 'Planos Orçamentarios - Detalhes')
        ...
        <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    ...
                    <h3 class="profile-username text-center">PPA 2024 - 2027</h3>
                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                            <b>Inicio</b> <a class="float-right">01/01/2024</a>
                        </li>
                        <li class="list-group-item">
                            <b>Fim</b> <a class="float-right">31/12/2027</a>
                        </li>
                        <li class="list-group-item">
            ...
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#unocs" data-toggle="tab">Unidades Orçamentárias</a></li>
                    </ul>
                </div>
                <div class="card-body">
